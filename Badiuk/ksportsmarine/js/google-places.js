...
(function ($) {
  ...
  $.googlePlaces = function (element, options) {
    ...
    var defaults = {
      placeId: 'ChIJ-bEQXHkIvlIR6VBI4RU856E' // placeId provided by google api documentation
      , render: ['reviews']
      , min_rating: 5
      , max_rows: 0
      , rotateTime: false
...
jQuery(document).ready(function ($) {
  $("#google-reviews").googlePlaces({ placeId: 'ChIJ-bEQXHkIvlIR6VBI4RU856E' })
});
