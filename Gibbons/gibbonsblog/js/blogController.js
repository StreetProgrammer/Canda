...
$(document).ready(function () {
    var PostsContainer = $('.content-area .row')
    ...
    PostsContainer.html(arrayOfPostsArrays[0])
    ...
    function prpareNumericPaginate(nowindex) {
        ...
        if (nowindex === 0 || nowindex === 1 || nowindex === 2) {
            ...
            rightSpans[nowindex - 10] = rightSpans[nowindex - 10].substring(0, 5) + ' class="active" ' + rightSpans[nowindex - 10].substring(5)
    ...
    if ($('.about-author-box').length) {
        $('.about-author-box').remove();
    }
