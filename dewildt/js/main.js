...
$(document).ready(function() {
    if ($('#normal_vdp').length) {
        ...
        if (locationsLabel.length) {
            ...
            var locations = {
                hamilton: '<div class="_location-content">\
            <p>\
            <b>Hamilton</b></p>\
            ...
            <a class="tel-4" href="tel:9055736559">(905) 573-6559</a></p></div>',
                innisfil: '<div class="_location-content">\
        <p>\
        <b>Innisfil</b></p>\
        ...
        <p>\
        <b>Phone:</b>\
        <a class="tel-5" href="tel:7059150800">(705) 915-0800</a></p>\
        </div>',
                peterborough: '<div class="_location-content">\
        <p>\
        <b>Peterborough</b></p>\
...
$(document).ready(function() {
    ...
    changeSRPOverviewContentLocation();
});
...
function changeSRPOverviewContentLocation() {
    if (
        $('#page_60791').length ||
        $('#page_60792').length ||
        $('#page_60793').length ||
        ...
        if ($('.our-price').length) {
            $('.our-price').text('Starting from');
        }

        if ($('.model-tabs.container-fluid')) {
            var targetEl = $('.model-tabs.container-fluid');
            targetEl.appendTo($('#ad-right-content'));
            targetEl.css('width', 'auto');
        }
    }
}
