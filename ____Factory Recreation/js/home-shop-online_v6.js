...
$(function () {
  ...
  $.getJSON(
    ...
    function (data) {
      ...
      $.each($masterOfFilters.model_filter, function (modelkey, modelval) {
        ...
        $('.main-tabs').append(
          '<li class="dropdown"><a href="#" id="' +
            $modelClass +
            '" class="dropdown-toggle" data-toggle="dropdown" role="button">' +
            modelkey +
            '&nbsp;&nbsp;<i class="fas fa-caret-down"></i></a>\
					<div class="dropdown-menu mega-level-2">\
					<div class="level-2-hdr"><div>Shop ' +
            modelkey +
            '</div><div><a href="#" class="mega-filter-link" data-filter="&filters[model]=' +
            modelkey +
            '">All ' +
            modelkey +
  ...
  if ($('.parts2021').size()) {
    ...
    $('.available').after(
      '<div class="shipping-box"><img src="/site-uploads/1001348/Images/shipping_icon_s.jpg" /><span class="shipping-msg">Online orders ship out same day before 12pm. <br/> Orders after 12pm will ship next business day!</span></div>'
    );
  }
  ...
  if ($supported_pages.includes(pageId)) {
    $('.header-1-nav').append(
      '<a class="shop-online-btn visible-xs" href="https://factoryrecreation-shoponline.com/" target="_blank">Shop Online&nbsp;&nbsp;<i class="fas fa-store-alt">&nbsp;</i></a>'
    );
  }
  ...
  /* Script to modify  Home ESC component and redirect it to the sop online page */
});

$(document).ajaxComplete(function () {
  $('#comp_1633682142936 .view-details, #comp_1633682142936 .pushstate').each(
    function () {
      temp = this.href;
